...
| DEC-0013 | Store-authoritative claim snapshots: Artifact Store is the authority for claim-set membership; deterministic digest-bound snapshots with strict fail-closed enumeration and stable-capture check; caller claim arrays rejected at runtime; stale analyses fail compilation closed; contracts 1.6.0 | ratified |
